...
class ArticleTest < ActiveSupport::TestCase
  ...
  test 'article without tile or content is invalid' do
    empty = Article.new
    no_title = Article.new(title: '', content: 'Lorem ipsum dolor sit amet.')
    no_content = Article.new(title: 'Sample Article', content: '')
    assert_not empty.valid?
    assert_not no_title.valid?
    assert_not no_content.valid?
  end
  ...
  test 'article metadata has default values' do
    article = Article.create(title: 'Sample Article', content: 'Lorem ipsum dolor sit amet.')
    assert_equal 'Anonymous', article.author
    assert_not_nil(article.date)
  end
  ...
  test 'displays all articles on empty search term' do
    article1 = Article.create(title: 'Sample Article', content: 'Lorem ipsum dolor sit amet.')
    article2 = Article.create(title: 'Another Article',
                              content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.')
