  ...
  def create
    ...
    respond_to do |format|
      ...
      if @article.save
        ...
        format.html { redirect_to articles_url, alert: "Article could not be created." }
  ...
  def update
    respond_to do |format|
      ...
      if @article.update(article_params)
        format.html { redirect_to article_url(@article), alert: "Article was successfully updated." }
        format.json { render json: @article, status: :ok }
      else
        format.html { redirect_to articles_url, alert: "Article could not be updated." }
        format.json { render json: @article.errors, status: :unprocessable_entity }
      end
    end
  end
