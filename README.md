...
### Generate Dev build
1. run `bundle install` in the root directory of the repo to install required gems
2. run `rails db:migrate` in the root directory of the repo to intialize the database
3. run `rails server` to create a develoepr build of the project
4. Access the app on http://localhost:3000/
5. Access RDoc documenation by opening the `./doc/index.html` file in your browser
